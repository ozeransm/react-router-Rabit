...
function Admin({
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    isOpenModal && /* @__PURE__ */ jsx(Modal, { products, card, rows, setCard, setProductState, setIsOpenModal, isOpenModal, url: url2, endPoint }),
    /* @__PURE__ */ jsxs(StyledBaseField$2, { children: [
      /* @__PURE__ */ jsx("h2", { children: "Administrator" }),
      /* @__PURE__ */ jsx(Catalog, { products, card, rows, setCard, setProductState, setIsOpenModal, isOpenModal, url: url2, endPoint }),
      /* @__PURE__ */ jsx(MyForm, { products, card, rows, setCard, setProductState, setIsOpenModal, isOpenModal, url: url2, endPoint })
    ] })
  ] });
}
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs(StyledBaseField, { children: [
      ...
      /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit(onSubmit), children: [
        /* @__PURE__ */ jsx("input", { ...register("login", {
          required: true
        ...
        /* @__PURE__ */ jsxs("div", { style: {
          ...
          /* @__PURE__ */ jsx("span", { onClick: () => setShowPassword(!showPassword), style: {
            position: "absolute",
            right: "10px",
            top: "50%",
...
function App({
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsx(Routes, { children: /* @__PURE__ */ jsxs(Route, { path: "/", element: /* @__PURE__ */ jsx(Layout, {}), children: [
      ...
      /* @__PURE__ */ jsx(Route, { path: "login", element: /* @__PURE__ */ jsx(Login, { products: productState, card, rows, setCard, setProductState, setIsOpenModal, isOpenModal, url, endPoint: "users" }) }),
