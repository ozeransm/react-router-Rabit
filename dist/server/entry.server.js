...
function Modal({
  ...
  return /* @__PURE__ */ jsx(StyledOverlay, {
    children: /* @__PURE__ */ jsxs(StyledBaseField$1, {
      children: [
      ...
      /* @__PURE__ */ jsx('div', {
        children: products.map((p) =>
          /* @__PURE__ */ jsxs(
            ...
            {
              children: [
                /* @__PURE__ */ jsxs('h3', { children: ['Name: ', p.name] }),
                /* @__PURE__ */ jsxs('p', { children: ['id: ', p.id] }),
                /* @__PURE__ */ jsxs('p', {
                  children: ['Description: ', p.description],
                }),
                /* @__PURE__ */ jsxs('p', { children: ['Price: ', p.price] }),
                /* @__PURE__ */ jsxs('p', { children: ['images: ', p.img] }),
              ],
            },
            p.id
          )
      ...
      /* @__PURE__ */ jsx(Routes, {
        children: /* @__PURE__ */ jsxs(Route, {
          ...
          children: [
            /* @__PURE__ */ jsx(Route, {
              index: true,
              element: /* @__PURE__ */ jsx(Home, { products }),
            }),
            /* @__PURE__ */ jsx(Route, {
              path: 'admin',
