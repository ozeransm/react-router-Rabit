...
(function (r, a) {
  (function () {
    ...
    var Ee = function (b, A, Y, K, Se, Qe, Pe) {
    ...
    function Ue(b, A, Y) {
      ...
      if (A != null) {
        ...
        for (K in A) V.call(A, K) && !q.hasOwnProperty(K) && (Se[K] = A[K]);
      }
      ...
      if (b && b.defaultProps) {
        var qt = b.defaultProps;
        for (K in qt) Se[K] === void 0 && (Se[K] = qt[K]);
      }
      if (Qe || Pe) {
        var an =
      ...
      return Ee(b, Qe, Pe, tt, mt, ae.current, Se);
    }
    function lt(b, A) {
    ...
    function Tt(b, A, Y) {
      ...
      if (It === 1) Se.children = Y;
        ...
        for (var qt = Array(It), an = 0; an < It; an++)
          qt[an] = arguments[an + 2];
        Se.children = qt;
      }
    ...
    function aa(b, A, Y, K, Se) {
      ...
      if (ot(b))
        for (var di = 0; di < b.length; di++)
          ((It = b[di]), (qt = _t + Wt(It, di)), (an += aa(It, A, Y, qt, Se)));
      else {
        var zo = R(b);
    ...
    function fe(b, A) {
      ...
      var Y = { $$typeof: D, type: b, compare: A === void 0 ? null : A };
      {
        ...
        Object.defineProperty(Y, 'displayName', {
          ...
          set: function (Se) {
            ((K = Se), !b.name && !b.displayName && (b.displayName = Se));
          },
        });
      }
      return Y;
...
Check the top-level render call using <` +
    ...
    function la(b, A, Y) {
      for (
        var K = Tt.apply(this, arguments), Se = 2;
        Se < arguments.length;
        Se++
      )
        Ju(arguments[Se], K.type);
      return (_n(K), K);
    }
    function Fd(b, A) {
      var Y = F.transition;
    ...
    function nc(b) {
      {
        ...
        try {
          if (
            ...
            var Se = U.current;
            Se !== null && ((U.didScheduleLegacyUpdate = !1), Po(Se));
          }
        } catch (qt) {
          throw (Oa(A), qt);
        } finally {
  ...
  function Ra(M) {
    {
      ...
      } else if (fe.PropTypes !== void 0 && !Wt) {
        Wt = !0;
        var ht = W(fe);
        R(
          'Component %s declared `PropTypes` instead of `propTypes`. Did you misspell the property assignment?',
 ...
 */ (function (r) {
  (function () {
    ...
    function d(Ee) {
      ...
      var Ue = Ee[0],
        lt = Ee.pop();
      return (lt !== Ue && ((Ee[0] = lt), m(Ee, lt, 0)), Ue);
    }
    function h(Ee, Ue, lt) {
      for (var Tt = lt; Tt > 0; ) {
        var At = (Tt - 1) >>> 1,
          rn = Ee[At];
        if (g(rn, Ue) > 0) ((Ee[At] = Ue), (Ee[Tt] = rn), (Tt = At));
        else return;
      }
    }
    function m(Ee, Ue, lt) {
      for (var Tt = lt, At = Ee.length, rn = At >>> 1; Tt < rn; ) {
        ...
        if (g(kn, Ue) < 0)
          Ut < At && g(hr, kn) < 0
            ? ((Ee[Tt] = hr), (Ee[Ut] = Ue), (Tt = Ut))
            : ((Ee[Tt] = kn), (Ee[Jt] = Ue), (Tt = Jt));
        else if (Ut < At && g(hr, Ue) < 0)
          ((Ee[Tt] = hr), (Ee[Ut] = Ue), (Tt = Ut));
        else return;
      }
    }
    function g(Ee, Ue) {
      var lt = Ee.sortIndex - Ue.sortIndex;
      return lt !== 0 ? lt : Ee.id - Ue.id;
    }
    var S = 1,
      E = 2,
      T = 3,
    ...
    function we(Ee) {
      if (((ve = !1), Lt(Ee), !ce))
        if (f(te) !== null) ((ce = !0), Me(Ce));
        else {
          var Ue = f(se);
          Ue !== null && Be(we, Ue.startTime - Ee);
        }
    }
    function Ce(Ee, Ue) {
    ...
    function _e(Ee, Ue) {
      ...
      for (
        Lt(lt), W = f(te);
        W !== null && !a && !(W.expirationTime > lt && (!Ee || un()));
        ...
        if (typeof Tt == 'function') {
          ...
          var At = W.expirationTime <= lt,
            rn = Tt(At);
          ((lt = r.unstable_now()),
            typeof rn == 'function' ? (W.callback = rn) : W === f(te) && d(te),
            Lt(lt));
        } else d(te);
        W = f(te);
      }
    ...
    function ye(Ee, Ue, lt) {
      ...
      return (
        At > Tt
          ...
          : ((Ut.sortIndex = kn), c(te, Ut), !ce && !pe && ((ce = !0), Me(Ce))),
        Ut
      );
    }
    function it() {}
 ...
 */ (function () {
  ...
  (aa.forEach(function (e) {
    ...
    [
      ...
      var t = e[0],
        n = e[1];
      Wt[t] = new Gt(t, re, !1, n, null, !1, !1);
    }),
    ['contentEditable', 'draggable', 'spellCheck', 'value'].forEach(
      function (e) {
        Wt[e] = new Gt(e, Me, !1, e.toLowerCase(), null, !1, !1);
      }
    ),
    [
      'autoReverse',
    ...
    [
      ...
      Wt[e] = new Gt(e, Be, !1, e.toLowerCase(), null, !1, !1);
    }),
    ['checked', 'multiple', 'muted', 'selected'].forEach(function (e) {
      Wt[e] = new Gt(e, Be, !0, e, null, !1, !1);
    }),
    ['capture', 'download'].forEach(function (e) {
      Wt[e] = new Gt(e, et, !1, e, null, !1, !1);
    }),
    ['cols', 'rows', 'size', 'span'].forEach(function (e) {
      Wt[e] = new Gt(e, or, !1, e, null, !1, !1);
    }),
    ['rowSpan', 'start'].forEach(function (e) {
      Wt[e] = new Gt(e, nn, !1, e.toLowerCase(), null, !1, !1);
    }));
  var Ur = /[\-\:]([a-z])/g,
    ji = function (e) {
  ...
  ([
    ...
    [
      ...
      var t = e.replace(Ur, ji);
      Wt[t] = new Gt(t, re, !1, e, 'http://www.w3.org/1999/xlink', !1, !1);
    }),
    ...
    ['tabIndex', 'crossOrigin'].forEach(function (e) {
      Wt[e] = new Gt(e, re, !1, e.toLowerCase(), null, !1, !1);
    }));
  var Ao = 'xlinkHref';
  ((Wt[Ao] = new Gt(
    'xlinkHref',
    ...
    ['src', 'href', 'action', 'formAction'].forEach(function (e) {
      Wt[e] = new Gt(e, re, !1, e.toLowerCase(), null, !0, !0);
    }));
  var Vl =
      /^[\u0000-\u001F ]*j[\r\n\t]*a[\r\n\t]*v[\r\n\t]*a[\r\n\t]*s[\r\n\t]*c[\r\n\t]*r[\r\n\t]*i[\r\n\t]*p[\r\n\t]*t[\r\n\t]*\:/i,
    $i = !1;
    ...
    if (i.mustUseProperty) {
      ...
      if (i.type === et) {
        if (e.hasAttribute(u)) {
          ...
          return v === '' ? !0 : Ut(t, n, i, !1) ? v : v === '' + n ? n : v;
        }
      } else if (e.hasAttribute(u)) {
        if (Ut(t, n, i, !1)) return e.getAttribute(u);
        if (i.type === Be) return n;
        p = e.getAttribute(u);
      }
      return Ut(t, n, i, !1) ? (p === null ? n : p) : p === '' + n ? n : p;
    }
  }
  function ri(e, t, n, i) {
    {
  ...
  function _a(e, t, n, i) {
    ...
    if (!Jt(t, l, i)) {
      ...
      if (n === null) e.removeAttribute(w);
        ...
        (z === Be || (z === et && n === !0)
          ? (P = '')
          : (Ot(n, w), (P = '' + n), l.sanitizeURL && Yi(P.toString())),
  ...
  var Vr = Symbol.for('react.element'),
    ...
    Qt = Symbol.for('react.legacy_hidden'),
...
Check the render method of \`` +
  ...
  if (
    ...
    eg = function (t, n, i, l, u, p, v, y, w) {
      ...
      if (
        ...
        return (Z(), Zy.apply(this, arguments));
    };
  }
  var Rx = eg,
    Ho = !1,
  ...
  function Y0(e) {
    for (
      ...
      i < yi.length && Fp(t, yi[i].priority);
      i++
    );
  ...
  function Er(e) {
    function t(n, i, l, u, p) {
      ...
      return (
        w ? (this.isDefaultPrevented = _c) : (this.isDefaultPrevented = Ug),
  ...
  var Jg = !1;
  ot &&
    (Jg = HR('input') && (!document.documentMode || document.documentMode > 9));
  function WR(e, t) {
  ...
  function qR(e, t, n) {
    e === 'focusin' ? (Zg(), WR(t, n)) : e === 'focusout' && Zg();
  }
  function XR(e, t) {
...
`
  ...
  function P_(e, t, n, i) {
    ...
    switch (t) {
      ...
      case 'video':
      case 'audio':
        for (var p = 0; p < ks.length; p++) Xt(ks[p], e);
        u = n;
        break;
      case 'source':
        (Xt('error', e), (u = n));
      ...
      case 'image':
      case 'link':
        (Xt('error', e), Xt('load', e), (u = n));
        break;
      case 'details':
        (Xt('toggle', e), (u = n));
        break;
      case 'input':
        (A(e, n), (u = b(e, n)), Xt('invalid', e));
        break;
      case 'option':
        (It(e, n), (u = n));
        break;
      case 'select':
        (ts(e, n), (u = es(e, n)), Xt('invalid', e));
        break;
      case 'textarea':
        (Ly(e, n), (u = Id(e, n)), Xt('invalid', e));
        break;
      default:
        u = n;
    }
            ...
            : y === Nc ||
              ...
              (it.hasOwnProperty(y)
                ? (P != null &&
                    ...
                    y === 'onScroll' && Xt('scroll', e)),
                  !u && j !== P && (u = []))
                : (u = u || []).push(y, P));
    }
    return (C && (tx(C, v[so]), (u = u || []).push(so, C)), u);
  }
  ...
  function V_(e, t, n, i, l, u, p) {
    ...
    switch (((v = Qi(t, n)), zc(t, n), t)) {
      ...
      case 'video':
      case 'audio':
        for (var w = 0; w < ks.length; w++) Xt(ks[w], e);
        break;
      case 'source':
        Xt('error', e);
        break;
    ...
    for (var G in n)
      if (n.hasOwnProperty(G)) {
        ...
        if (G === lo)
          typeof Z == 'string'
            ? e.textContent !== Z &&
              (n[bi] !== !0 && Vc(e.textContent, Z, u, p), (j = [lo, Z]))
            : typeof Z == 'number' &&
              e.textContent !== '' + Z &&
              (n[bi] !== !0 && Vc(e.textContent, Z, u, p), (j = [lo, '' + Z]));
  ...
  var fv = typeof setTimeout == 'function' ? setTimeout : void 0,
    ...
    iD =
      typeof queueMicrotask == 'function'
        ...
        : typeof _b < 'u'
          ? function (e) {
              return _b.resolve(null).then(e).catch(oD);
            }
          : fv;
  function oD(e) {
    setTimeout(function () {
  ...
  function c1(e) {
    ...
    return ((Lr = DD(t)), (Nn = e), (Yr = !0), (Ti = null), (vo = !1), !0);
  }
  function f1(e, t, n) {
    return (
      (Lr = OD(t)),
      ...
      (Gr.flushPendingUnsafeLifecycleWarnings = function () {
        ...
        Gs.length > 0 &&
          (Gs.forEach(function (P) {
            (e.add(st(P) || 'Component'), mo.add(P.type));
          }),
          (Gs = []));
        var t = new Set();
        Ws.length > 0 &&
          (Ws.forEach(function (P) {
            (t.add(st(P) || 'Component'), mo.add(P.type));
          }),
          (Ws = []));
        var n = new Set();
        qs.length > 0 &&
          (qs.forEach(function (P) {
            (n.add(st(P) || 'Component'), mo.add(P.type));
          }),
          (qs = []));
        var i = new Set();
        Xs.length > 0 &&
          (Xs.forEach(function (P) {
            (i.add(st(P) || 'Component'), mo.add(P.type));
          }),
          (Xs = []));
        var l = new Set();
        Qs.length > 0 &&
          (Qs.forEach(function (P) {
            (l.add(st(P) || 'Component'), mo.add(P.type));
          }),
          (Qs = []));
        var u = new Set();
        if (
          (Ks.length > 0 &&
            (Ks.forEach(function (P) {
              (u.add(st(P) || 'Component'), mo.add(P.type));
            }),
            (Ks = [])),
          t.size > 0)
        ) {
...
See https://reactjs.org/link/refs-must-have-owner for more information.`
  ...
  function Jb(e) {
    function t(I, ee) {
      if (e) {
        var H = I.deletions;
        H === null ? ((I.deletions = [ee]), (I.flags |= Ki)) : H.push(ee);
      }
    }
    function n(I, ee) {
      if (!e) return null;
    ...
    function u(I, ee, H) {
      if (((I.index = H), !e)) return ((I.flags |= tg), ee);
      var he = I.alternate;
      if (he !== null) {
        var ke = he.index;
    ...
    function Z(I, ee, H, he) {
      ...
      for (
        var at = null, zt = null, xt = ee, cn = 0, Rt = 0, ln = null;
        xt !== null && Rt < H.length;
        Rt++
      ) {
...
https://reactjs.org/link/unsafe-component-lifecycles`,
  ...
  function Q1(e, t, n, i, l) {
    ...
    var He = mf() || jS(t, n, v, i, Z, De, z) || xe;
    return (
      He
        ? (!G &&
...
` +
  ...
  function Uh(e, t, n) {
    ...
    return (
      p !== null &&
        ...
        (i.callback = function () {
          (aw(e), Fh(e, t), typeof l != 'function' && BA(this));
          var y = t.value,
            w = t.stack;
  ...
  function nE(e, t, n, i, l) {
    ...
    var G = t.stateNode,
      Z;
    G === null
      ? (Bf(e, t), YS(t, n, i), Ph(t, n, i, l), (Z = !0))
      : e === null
        ? (Z = X1(t, n, i, l))
        : (Z = Q1(e, t, n, i, l));
  ...
  function Yh(e, t, n, i, l, u) {
    tE(e, t);
    var p = (t.flags & Dt) !== qe;
    if (!i && !p) return (l && Fb(t, n, !1), Wa(e, t, u));
    var v = t.stateNode;
    cu.current = t;
    var y;
  ...
  function cO(e, t, n, i) {
    ...
    switch (w) {
      ...
      case g:
        return ((t.type = y = wm(y)), (z = nE(null, t, y, C, i)), z);
      case N:
        return ((t.type = y = Cm(y)), (z = KS(null, t, y, C, i)), z);
      case ae: {
        if (t.type !== t.elementType) {
          var P = y.propTypes;
          P && $r(P, C, 'prop', wt(y));
        }
        return ((z = JS(null, t, y, Xr(y.type, C), i)), z);
      }
    }
    var j = '';
    throw (
...
Check the render method of \`` +
  ...
  function iE(e, t, n) {
    ...
    if (
      (p || vO(l, e)
        ? ((u = !0), (t.flags &= ~Dt))
        : (e === null || e.memoizedState !== null) && (l = k1(l, dS)),
      (l = hl(l)),
      _i(t, l),
      e === null)
    ) {
  ...
  function gO(e, t, n, i, l) {
    ...
    if ((u & yt) === je && t.child !== p) {
      ...
      ((w = C),
        ...
        (t.deletions = null));
    } else ((w = oE(p, y)), (w.subtreeFlags = p.subtreeFlags & Fa));
    var z;
    return (
      v !== null ? (z = xo(v, i)) : ((z = Pi(i, u, l, null)), (z.flags |= pn)),
      (z.return = t),
      (w.return = t),
      (w.sibling = z),
      (t.child = w),
  ...
  function yE(e, t, n) {
    ...
    switch ((xv(t), t.tag)) {
      ...
      case D: {
        ...
        if (e !== null && t.stateNode != null)
          ...
          if (z) d1(t, y, C) && El(t);
            ...
            var P = J_(w, i, y, C, t);
            (vE(P, t, !1, !1), (t.stateNode = P), eD(P, w, i, y) && El(t));
          }
          t.ref !== null && pE(t);
        }
        return (Fn(t), null);
      ...
      case U: {
        ...
        if (pt !== I && pt) {
          var ee = t.child;
          if (((ee.flags |= Zi), (t.mode & yt) !== je)) {
            var H =
              e === null &&
              (t.memoizedProps.unstable_avoidThisFallback !== !0 || !Lt);
            H || Xv(Wr.current, dS) ? kA() : ym();
          }
        }
      ...
      case ie: {
        ...
        return (
          !Ol || (t.mode & yt) === je
            ? Fn(t)
            : br(ba, gr) &&
              (Fn(t), t.subtreeFlags & (pn | St) && (t.flags |= Zi)),
          null
        );
      }
      case pe:
    ...
    if (l !== null) {
      ...
      do {
        if ((p.tag & e) === e) {
          ...
          ((p.destroy = void 0),
            v !== void 0 &&
              ((e & zn) !== fr ? n0(t) : (e & bn) !== fr && fg(t),
              (e & pa) !== fr && _u(!0),
              $f(t, n, v),
              (e & pa) !== fr && _u(!1),
              (e & zn) !== fr ? r0() : (e & bn) !== fr && dg()));
        }
        p = p.next;
      } while (p !== u);
    }
...
Learn more about data fetching with Hooks: https://reactjs.org/link/hooks-data-fetching`)
  ...
  function _E(e, t, n) {
    switch ((Qx(n), n.tag)) {
      ...
      case W: {
        if (n.mode & yt) {
          var Z = Un;
          ((Un = Z || n.memoizedState !== null), Mi(e, t, n), (Un = Z));
        } else Mi(e, t, n);
        break;
      }
      default: {
    ...
    if (p !== qa) {
      ...
      if (p === om) Ni(e, l);
        ...
        if (w && !OA(C)) {
          ...
          if (p === mu) {
            var P = gu;
            throw (Co(e, de), Ni(e, l), pr(e, Dn()), P);
          }
        }
  ...
  function Co(e, t) {
    ...
    if ((n !== dv && ((e.timeoutHandle = dv), aD(n)), en !== null))
  ...
  function FA(e, t) {
    ...
    return (
      ...
      GE(i),
      (gt = n),
      en !== null ? (d0(), qa) : (vg(), (tr = null), (Cn = de), Tn)
    );
  }
  function UA() {
    for (; en !== null && !Ix(); ) WE(en);
  }
  function WE(e) {
    var t = e.alternate;
    Zt(e);
...
Check the render method of \`` +
  ...
  function fw(e, t, n, i, l, u, p, v, y, w) {
    var C = !0,
      z = sw(n, i, C, e, l, u, p, v, y);
    z.context = uw(null);
    var P = z.current,
      j = nr(),
      G = ki(P),
      Z = Ga(j, G);
    return ((Z.callback = t ?? null), xi(P, Z, G), RA(z, G, j), z);
  }
  function Du(e, t, n, i) {
    Wx(t, e);
    var l = t.current,
...
Check the render method of %s.`,
  ...
  function od(e, t, n, i, l) {
    (kw(n), NM(l === void 0 ? null : l, 'render'));
...
var JM = NC.exports,
  ...
  Uw = JM;
{
  var Vw = Uw.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
  FC = function (r, a, o) {
    Vw.usingClientEntryPoint = !0;
    try {
      return Uw.hydrateRoot(r, a, o);
    } finally {
...
function UC(r, a, o, s) {
  ...
  let c = (f, d, h) => {
    ...
    (f.children &&
      ...
      UC(f.children, a, S, g)),
      !(f.path == null && !f.index) &&
        a.push({ path: g, score: fL(g, f.index), routesMeta: S }));
  };
  return (
    r.forEach((f, d) => {
      var h;
      if (f.path === '' || !((h = f.path) != null && h.includes('?'))) c(f, d);
      else for (let m of VC(f.path)) c(f, d, m);
    }),
    a
  );
}
...
function fL(r, a) {
  ...
  return (
    ...
    o
      .filter((c) => !jw(c))
      .reduce((c, f) => c + (iL.test(f) ? oL : f === '' ? sL : uL), s)
  );
}
function dL(r, a) {
  ...
  for (let h = 0; h < s.length; ++h) {
    ...
    (Object.assign(c, E.params),
      d.push({
        ...
        pathnameBase: bL(ni([f, E.pathnameBase])),
        route: T,
      }),
...
function Sd(r, a) {
  ...
  let [o, s] = vL(r.path, r.caseSensitive, r.end),
    c = a.match(o);
  if (!c) return null;
  let f = c[0],
    d = f.replace(/(.)\/+$/, '$1'),
...
function mL(r, a) {
  ...
  return {
    pathname: o ? (o.startsWith('/') ? o : yL(o, a)) : a,
    search: SL(s),
    hash: EL(c),
  };
}
...
const ni = (r) => r.join('/').replace(/\/\/+/g, '/'),
  bL = (r) => r.replace(/\/+$/, '').replace(/^\/*/, '/'),
  SL = (r) => (!r || r === '?' ? '' : r.startsWith('?') ? r : '?' + r),
...
const fy = ne.createContext(null);
fy.displayName = 'DataRouterState';
const TL = ne.createContext(null);
...
function _L() {
  ...
  let r = ne.useContext(Bu),
    ...
    { pathname: f } = Fl(),
    d = JSON.stringify(IC(c, o.v7_relativeSplatPath)),
    h = ne.useRef(!1);
  return (
    $C(() => {
      h.current = !0;
    ...
    ne.useCallback(
      function (g, S) {
        if ((S === void 0 && (S = {}), Ta(h.current, jC), !h.current)) return;
        if (typeof g == 'number') {
          s.go(g);
          return;
        }
        let E = HC(g, JSON.parse(d), f, S.relative === 'path');
        (r == null &&
          a !== '/' &&
...
const DL = ne.createContext(null);
function OL(r) {
  let a = ne.useContext(xa).outlet;
  return a && ne.createElement(DL.Provider, { value: r }, a);
}
function Yu(r, a) {
  let { relative: o } = a === void 0 ? {} : a,
    ...
    { matches: c } = ne.useContext(xa),
    { pathname: f } = Fl(),
    d = JSON.stringify(IC(c, s.v7_relativeSplatPath));
  return ne.useMemo(() => HC(r, JSON.parse(d), f, o === 'path'), [r, d, f, o]);
}
function AL(r, a) {
  return ML(r, a);
}
...
const kL = ne.createElement(LL, null);
class NL extends ne.Component {
  constructor(a) {
    (super(a),
      (this.state = {
        location: a.location,
...
function JL(r, a) {
  return r.button === 0 && (!a || a === '_self') && !KL(r);
}
let ld = null;
function ZL() {
  if (ld === null)
...
function tk(r, a) {
  ...
  if (XL(r)) {
    ...
    ((s = h ? Bi(h, a) : null),
      ...
      (f = new FormData(r)));
  } else if (qL(r) || (QL(r) && (r.type === 'submit' || r.type === 'image'))) {
    let h = r.form;
    if (h == null)
      throw new Error(
...
const WC = ne.createContext({ isTransitioning: !1 });
WC.displayName = 'ViewTransition';
const ok = ne.createContext(new Map());
ok.displayName = 'Fetchers';
const lk = 'startTransition',
  Gw = QM[lk];
function sk(r) {
  let { basename: a, children: o, future: s, window: c } = r,
    f = ne.useRef();
  f.current == null && (f.current = ZM({ window: c, v5Compat: !0 }));
  let d = f.current,
...
const uk =
  ...
  Fi = ne.forwardRef(function (a, o) {
    let {
      ...
      O,
      x = !1;
    if (typeof g == 'string' && ck.test(g) && ((O = g), uk))
      try {
...
Fi.displayName = 'Link';
const fk = ne.forwardRef(function (a, o) {
  let {
      'aria-current': s = 'page',
      caseSensitive: c = !1,
      className: f = '',
...
fk.displayName = 'NavLink';
const dk = ne.forwardRef((r, a) => {
  let {
      fetcherKey: o,
      navigate: s,
      reloadDocument: c,
...
let mk = 0,
  yk = () => '__' + String(++mk) + '__';
function gk() {
  let { router: r } = qC(Ed.UseSubmit),
    { basename: a } = ne.useContext(ra),
    o = IL();
  return ne.useCallback(
    function (s, c) {
      (c === void 0 && (c = {}), hk());
      let { action: f, method: d, encType: h, formData: m, body: g } = tk(s, a);
      if (c.navigate === !1) {
        let S = c.fetcherKey || yk();
...
function Sk(r, a) {
  a === void 0 && (a = {});
  let o = ne.useContext(WC);
  o == null &&
    tn(
      !1,
      "`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?"
    );
  let { basename: s } = qC(Ed.useViewTransitionState),
...
function Ek(r) {
  ...
  function f(we, Ce) {
    ...
    return (
      ...
      xe(Ce !== 2 ? Ve : Ve.replace(J, '$1'), _e, Ce)
    );
  }
  function d(we, Ce) {
  ...
  function h(we, Ce, _e, Ve, $, Je, ye, it, Xe, Ze) {
    for (var ue = 0, ot = Ce, dt; ue < be; ++ue)
      switch ((dt = ve[ue].call(S, we, ot, _e, Ve, $, Je, ye, it, Xe, Ze))) {
        case void 0:
        case !1:
        case !0:
        case null:
 ...
 */ (function () {
  ...
  ((Ft.AsyncMode = U),
    (Ft.ConcurrentMode = ae),
    (Ft.ContextConsumer = Q),
    (Ft.ContextProvider = le),
    (Ft.Element = J),
    (Ft.ForwardRef = te),
    (Ft.Fragment = se),
    (Ft.Lazy = B),
    ...
    (Ft.Suspense = ve),
    (Ft.isAsyncMode = xe),
    (Ft.isConcurrentMode = Ye),
    (Ft.isContextConsumer = Lt),
    (Ft.isContextProvider = we),
    (Ft.isElement = Ce),
    (Ft.isForwardRef = _e),
    (Ft.isFragment = Ve),
    (Ft.isLazy = $),
...
gy[yy.Memo] = KC;
function Xw(r) {
  return yy.isMemo(r) ? KC : gy[r.$$typeof] || Rk;
}
var Ok = Object.defineProperty,
  Ak = Object.getOwnPropertyNames,
  Qw = Object.getOwnPropertySymbols,
  Mk = Object.getOwnPropertyDescriptor,
  Lk = Object.getPrototypeOf,
  Kw = Object.prototype;
function JC(r, a, o) {
  if (typeof a != 'string') {
    if (Kw) {
...
var Nl =
  ...
  Pk = !!(typeof SC_DISABLE_SPEEDY == 'boolean'
    ? SC_DISABLE_SPEEDY
    : typeof process < 'u' &&
      process.env !== void 0 &&
...
function Ul(r) {
  for (
    ...
    o[s - 1] = arguments[s];
  throw new Error(Fk.apply(void 0, [zk[r]].concat(o)).trim());
}
var Uk = (function () {
    function r(o) {
...
`;
  ...
  Hk = 'style[' + Nl + '][data-styled-version="5.3.11"]',
  Bk = new RegExp('^' + Nl + '\\.g(\\d+)\\[id="([\\w\\d-]+)"\\].*?"([^"]*)'),
  jk = function (r, a, o) {
...
`),
      ...
      if (d) {
        ...
        if (h) {
          var m = 0 | parseInt(h[1], 10),
            g = h[2];
          (m !== 0 && (Ik(g, m), jk(r, g, h[3]), r.getTag().insertRules(m, s)),
            (s.length = 0));
        } else s.push(d);
      }
    }
  ...
  Zw = by,
  Xk = { isServer: !by, useCSSOMInjection: !Pk },
  tT = (function () {
    function r(o, s, c) {
      (o === void 0 && (o = Hi),
        s === void 0 && (s = {}),
        (this.options = ti({}, Xk, {}, o)),
        (this.gs = s),
        ...
        !this.server &&
          ...
          (function (f) {
            for (
              var d = document.querySelectorAll(Hk), h = 0, m = d.length;
              h < m;
              h++
            ) {
              var g = d[h];
              g &&
                ...
                ($k(f, g), g.parentNode && g.parentNode.removeChild(g));
            }
          })(this)));
    }
      ...
      (a.getTag = function () {
        return (
          ...
          (this.tag =
            ...
            (d = s.target),
            (o = c ? new qk(d) : f ? new Gk(d) : new Wk(d)),
            new Uk(o)))
        );
        var o, s, c, f, d;
      }),
...
function tN(r) {
  var a,
    ...
    D = function (x, k, L) {
      return (k === 0 && eN.indexOf(L[o.length]) !== -1) || L.match(c)
        ? x
        : '.' + a;
    };
  function O(x, k, L, R) {
...
var rT = Ct.createContext();
rT.Consumer;
var aT = Ct.createContext(),
  nN = (aT.Consumer, new tT()),
  iy = tN();
function rN() {
  return ne.useContext(rT) || nN;
}
function aN() {
  return ne.useContext(aT) || iy;
}
var iN = (function () {
    function r(a, o) {
      var s = this;
...
function tC(r) {
  return oN.test(r) ? r.replace(lN, uN).replace(sN, '-ms-') : r;
}
var nC = function (r) {
  return r == null || r === !1 || r === '';
};
function Pl(r, a, o, s) {
  ...
  if (nC(r)) return '';
  if (ZC(r)) return '.' + r.styledComponentId;
  if (Cd(r)) {
    if (
      typeof (g = r) != 'function' ||
...
To resolve this only create new StyledComponents outside of any render method and function component.`,
  ...
  vN = /(^-|-$)/g;
function Bm(r) {
  return r.replace(pN, '-').replace(vN, '');
}
var hN = function (r) {
  return ay(nT(r) >>> 0);
};
...
function iT(r) {
  ...
  for (var c = 0, f = o; c < f.length; c++) {
    var d = f[c];
    if (oy(d)) for (var h in d) mN(h) && yN(r, d[h], h);
  }
  return r;
}
var oT = Ct.createContext();
oT.Consumer;
var jm = {};
function lT(r, a, o) {
  var s = ZC(r),
  ...
  s &&
    ...
    (D = a.shouldForwardProp
      ...
      : r.shouldForwardProp);
  var O,
    x = new Jk(o, E, s ? r.componentStyle : void 0),
    ...
    L = function (R, N) {
      return (function (F, U, ae, Q) {
        var le = F.attrs,
          ...
          })(dN(U, ne.useContext(oT), te) || Hi, U, le),
          ce = pe[0],
          ve = pe[1],
  ...
  return (
    ...
    (O.withComponent = function (R) {
      ...
      return lT(R, ti({}, F, { attrs: T, componentId: U }), o);
    }),
    Object.defineProperty(O, 'defaultProps', {
      ...
      set: function (R) {
        this._foldedDefaultProps = s ? iT({}, r.defaultProps, R) : R;
      },
    }),
    fN(S, E),
...
var ly = function (r) {
  return (function a(o, s, c) {
    ...
    var f = function () {
      return o(s, c, cN.apply(void 0, arguments));
    };
    return (
...
function TN(r, a) {
  ...
  return (
    !s &&
      ...
      ((s = [...a.assignedElements()].includes(r)), s || (s = CN(r, a))),
    s
  );
}
function Rd(r) {
...
function fT(r) {
  return (r === void 0 && (r = {}), Ym || (Ym = MN(r)), Ym);
}
let Gm;
function LN() {
  const r = Kn(),
    ...
    if (
      ...
      if (o.slidesPerView === 'auto') {
        ...
        if (
          ...
          le = r.isHorizontal() ? lC(se, 'width', !0) : lC(se, 'height', !0);
        else {
          const pe = a(B, 'width'),
            ce = a(B, 'padding-left'),
          ...
          if (Ye && Ye === 'border-box') le = pe + be + xe;
            ...
            const { clientWidth: Lt, offsetWidth: we } = se;
...
function BN() {
  ...
  (m &&
    (d ||
      ((S = _N(m, `.${o.slideClass}, swiper-slide`)[0]),
      o.loop && !S && (S = a[0]),
      (g = RN(m, `.${o.slideClass}, swiper-slide`)[0]),
...
function $N(r) {
  ...
  if ((typeof m > 'u' && (m = jN(a)), s.indexOf(o) >= 0)) g = s.indexOf(o);
  else {
...
var GN = {
  ...
  updateSlidesProgress: IN,
  updateProgress: HN,
  updateSlidesClasses: BN,
  updateActiveIndex: $N,
  updateClickedSlide: YN,
};
function WN(r) {
  ...
  if (
    ...
    if (a === 0) h[E ? 'scrollLeft' : 'scrollTop'] = -S;
      ...
      if (!f.support.smoothScroll)
        return (
          uT({ swiper: f, targetPosition: -S, side: E ? 'left' : 'top' }),
          !0
        );
...
function eP(r, a) {
  ...
  s.cssMode ||
    ...
    pT({ swiper: o, runCallbacks: r, direction: a, step: 'Start' }));
}
function tP(r, a) {
  r === void 0 && (r = !0);
  const o = this,
  ...
  ((o.animating = !1),
    !s.cssMode &&
      (o.setTransition(0),
      pT({ swiper: o, runCallbacks: r, direction: a, step: 'End' })));
}
var nP = { setTransition: ZN, transitionStart: eP, transitionEnd: tP };
function rP(r, a, o, s, c) {
  (r === void 0 && (r = 0),
    o === void 0 && (o = !0),
  ...
  if (h.cssMode) {
    ...
    if (a === 0)
      ...
      if (!f.support.smoothScroll)
        return (
          uT({ swiper: f, targetPosition: le, side: Q ? 'left' : 'top' }),
          !0
        );
...
var vP = { loopCreate: fP, loopFix: dP, loopDestroy: pP };
function hP(r) {
  const a = this;
  if (
...
var yP = { setGrabCursor: hP, unsetGrabCursor: mP };
function gP(r, a) {
  a === void 0 && (a = this);
  function o(s) {
...
function bP(r) {
  ...
  let m = s.target;
  if (
    (f.touchEventsTarget === 'wrapper' && !TN(m, a.wrapperEl)) ||
  ...
  if (f.noSwiping && (T ? gP(E, m) : m.closest(E))) {
    a.allowClick = !0;
    return;
  }
...
function RP() {
  const r = this,
    { params: a } = r;
  ((r.onTouchStart = bP.bind(r)),
    (r.onTouchMove = SP.bind(r)),
    (r.onTouchEnd = EP.bind(r)),
    (r.onDocumentTouchStart = xP.bind(r)),
    a.cssMode && (r.onScroll = CP.bind(r)),
    (r.onClick = wP.bind(r)),
    (r.onLoad = TP.bind(r)),
    vT(r, 'on'));
}
...
var DP = { attachEvents: RP, detachEvents: _P };
...
var MP = { setBreakpoint: OP, getBreakpoint: AP };
function LP(r, a) {
  const o = [];
  return (
    r.forEach((s) => {
...
var PP = { addClasses: kP, removeClasses: NP };
function zP() {
  const r = this,
...
let wy = class ei {
  constructor() {
    ...
    ((h.__swiper__ = !0),
      (h.support = cT()),
      (h.device = fT({ userAgent: o.userAgent })),
      (h.browser = dT()),
      (h.eventsListeners = {}),
  ...
  destroy(a, o) {
    ...
    return (
      typeof s.params > 'u' ||
        ...
        a !== !1 &&
          (s.el && typeof s.el != 'string' && (s.el.swiper = null), bN(s)),
        (s.destroyed = !0)),
      null
    );
  }
  ...
  return (
    Ct.Children.toArray(r).forEach((o) => {
      ST(o)
        ...
        : o.props &&
          o.props.children &&
          ET(o.props.children).forEach((s) => a.push(s));
    }),
    a
  );
}
...
const pC = ne.createContext(null),
  WP = ne.createContext(null),
  Ld = ne.forwardRef(function (r, a) {
    ...
    const [g, S] = ne.useState('swiper'),
      ...
      ae = ne.useRef(null),
      Q = ne.useRef(null),
      { params: le, passedParams: J, rest: te, events: se } = HP(h),
      { slides: B, slots: W } = YP(f),
      ie = () => {
        O(!D);
      };
    Object.assign(le.on, {
    ...
    (ne.useEffect(() => () => {
      ...
      Nu(() => {
        ce();
        const xe = jP(J, R.current, B, N.current, (Ye) => Ye.key);
        return (
          (R.current = J),
          (N.current = B),
          xe.length &&
    ...
    return Ct.createElement(
      s,
      _d({ ref: k, className: bT(`${g}${o ? ` ${o}` : ''}`) }, te),
      Ct.createElement(
        WP.Provider,
        { value: L.current },
        W['container-start'],
...
function Cy(r) {
  ...
  function le() {
    ...
    a.params.scrollbar = qP(a, a.originalParams.scrollbar, a.params.scrollbar, {
      el: 'swiper-scrollbar',
    });
    ...
    let ce;
    (pe &&
      ((ce = pe.querySelector(XP(a.params.scrollbar.dragClass))),
...
function xy({ product: r }) {
  return sn(QP, {
    children: [
      Re(KP, { src: r.img[0], alt: r.name }),
      sn(JP, { children: ['ID: ', r.id] }),
      Re(ZP, { children: r.name }),
      sn(ez, { children: ['$', r.price] }),
    ],
  });
}
const tz = jt('div').withConfig({
...
var Gu = (r) => r.type === 'checkbox',
  ...
  ir = (r) => r == null;
const CT = (r) => typeof r == 'object';
var fn = (r) => !ir(r) && !Array.isArray(r) && CT(r) && !Do(r),
  iz = (r) =>
    fn(r) && r.target ? (Gu(r.target) ? r.target.checked : r.target.value) : r,
  oz = (r) => r.substring(0, r.search(/\.\d+(\.|$)/)) || r,
  lz = (r, a) => r.has(oz(a)),
  sz = (r) => {
...
const vC = { BLUR: 'blur', FOCUS_OUT: 'focusout', CHANGE: 'change' },
  ...
  uz = Ct.createContext(null);
uz.displayName = 'HookFormContext';
var cz = (r, a, o, s = !0) => {
...
const fz = typeof window < 'u' ? ne.useLayoutEffect : ne.useEffect;
...
function hn(r, a) {
  const o = Array.isArray(a) ? a : Nd(a) ? [a] : Dy(a),
    s = o.length === 1 ? r : hz(r, o),
    c = o.length - 1,
    f = o[c];
  return (
    s && delete s[f],
    c !== 0 &&
      ((fn(s) && vr(s)) || (Array.isArray(s) && mz(s))) &&
      hn(r, o.slice(0, -1)),
    r
  );
}
...
function Od(r, a = {}) {
  ...
  if (fn(r) || o)
    for (const s in r)
      Array.isArray(r[s]) || (fn(r[s]) && !xT(r[s]))
...
function RT(r, a, o) {
  ...
  if (fn(r) || s)
    for (const c in r)
      Array.isArray(r[c]) || (fn(r[c]) && !xT(r[c]))
        ? mn(a) || cy(o[c])
...
var _T = (r) => {
  ...
  DT = (r, { valueAsNumber: a, valueAsDate: o, setValueAs: s }) =>
    mn(r)
      ? r
      : a
        ? r === ''
  ...
  return Oy(a)
    ...
    : Ay(a)
      ...
      : TT(a)
        ...
        : Gu(a)
          ? _T(r.refs).value
          : DT(mn(a.value) ? r.ref.value : a.value, r);
}
var yz = (r, a, o, s) => {
    const c = {};
    for (const f of r) {
      ...
      : !o && c.isOnTouch
        ...
        : (o ? s.isOnBlur : c.isOnBlur)
          ...
          : (o ? s.isOnChange : c.isOnChange)
            ? r
            : !0,
  Cz = (r, a) => !_y(Fe(r, a)).length && hn(r, a),
  Tz = (r, a, o) => {
    const s = Pu(Fe(r, o));
    return (Kt(s, 'root', a[o]), Kt(r, o, s), r);
  },
  gd = (r) => Ca(r);
...
function Rz(r = {}) {
  ...
  const T = { array: hC(), state: hC() },
    ...
    k = (_, V) => {
      !a.disabled &&
        ...
        ((_ || Array.from(h.mount)).forEach((q) => {
          q && (V ? Kt(o.validatingFields, q, V) : hn(o.validatingFields, q));
        }),
        T.state.next({
    ...
    L = (_, V = [], q, me, X = !0, re = !0) => {
      if (me && q && !a.disabled) {
        ...
        if (re && Array.isArray(Fe(o.errors, _))) {
          ...
          (X && Kt(o.errors, _, Me), Cz(o.errors, _));
        }
        if (
    ...
    R = (_, V) => {
      (Kt(o.errors, _, V), T.state.next({ errors: o.errors }));
    },
    N = (_) => {
      ...
      if (!a.disabled) {
        if (!q || me) {
          (S.isDirty || E.isDirty) &&
            ...
            (re = Me !== Be.isDirty));
          const et = Ui(Fe(c, _), V);
          ((Me = !!Fe(o.dirtyFields, _)),
            et ? hn(o.dirtyFields, _) : Kt(o.dirtyFields, _, !0),
    ...
    ae = (_, V, q, me) => {
      ...
      if (
        (a.delayError && q
          ...
          : (clearTimeout(g),
            (m = null),
            q ? Kt(o.errors, _, q) : hn(o.errors, _)),
        (q ? !Ui(X, q) : X) || !vr(me) || re)
      ) {
        const Me = {
          ...me,
    ...
    Q = async (_) => {
      ...
      const V = await a.resolver(
        f,
        a.context,
        yz(_ || h.mount, s, a.criteriaMode, a.shouldUseNativeValidation)
      );
      return (k(_), V);
    },
    le = async (_) => {
      ...
      if (_)
        for (const q of _) {
          const me = Fe(V, q);
          me ? Kt(o.errors, q, me) : hn(o.errors, q);
        }
      else o.errors = V;
      return V;
    },
        ...
        if (X) {
          ...
          if (re) {
            ...
            !V &&
              (Fe(nn, re.name)
                ? Be
                  ? Tz(o.errors, nn, re.name)
                  : Kt(o.errors, re.name, nn[re.name])
                : hn(o.errors, re.name));
          }
    ...
    se = (_, V) => !a.disabled && (_ && V && Kt(f, _, V), !Ui(Ye(), c)),
    B = (_, V, q) =>
      dz(_, h, { ...(d.mount ? f : mn(V) ? c : Ca(_) ? { [_]: V } : V) }, q, V),
    W = (_) =>
      _y(Fe(d.mount ? f : c, _, a.shouldUnregister ? Fe(c, _, []) : [])),
    ie = (_, V, q = {}) => {
      const me = Fe(s, _);
      let X = V;
      if (me) {
    ...
    ve = async (_) => {
      ...
      if (X) {
        let et, nn;
        const or = V.type ? bC(X._f) : iz(_),
          Ee = _.type === vC.BLUR || _.type === vC.FOCUS_OUT,
          Ue =
            (!bz(X._f) && !a.resolver && !Fe(o.errors, q) && !X._f.deps) ||
            wz(Ee, Fe(o.touchedFields, q), o.isSubmitted, Be, Me),
          lt = wC(q, h, Ee);
        (Kt(f, q, or),
          Ee
        ...
        const Tt = U(q, or, Ee),
          At = !vr(Tt) || lt;
        if ((!Ee && T.state.next({ name: q, type: _.type, values: Ln(f) }), Ue))
          return (
            (S.isValid || E.isValid) &&
        ...
        if ((!Ee && lt && T.state.next({ ...o }), a.resolver)) {
          ...
          (k([q], !0),
            ...
            me &&
              (et
                ? (nn = !1)
                : (S.isValid || E.isValid) && (nn = await J(s, !0))));
        me && (X._f.deps && xe(X._f.deps), ae(q, nn, et, Tt));
      }
    },
    be = (_, V) => {
    ...
    Ve = (_) =>
      T.state.subscribe({
        next: (V) => {
          Ez(_.name, V.name, _.exact) &&
            Sz(V, _.formState || S, Ge, _.reRenderRoot) &&
    ...
    ot = (_, V = {}) => {
      Fe(s, _) &&
        (mn(V.defaultValue)
          ? ce(_, Ln(Fe(c, _)))
          : (ce(_, V.defaultValue), Kt(c, _, Ln(V.defaultValue))),
      ...
      if ((V.keepDefaultValues || (c = q), !V.keepValues)) {
        if (V.keepDirtyValues) {
          ...
          for (const Be of Array.from(Me))
            Fe(o.dirtyFields, Be) ? Kt(re, Be, Fe(f, Be)) : ce(Be, Fe(re, Be));
        } else {
          if (Ry && mn(_))
...
function AT(r = {}) {
  ...
  return (
    ...
    Ct.useEffect(() => {
      r.values && !Ui(r.values, o.current)
        ? (f._reset(r.values, {
            keepFieldsRef: !0,
    ...
    (a.current.formState = cz(s, f)),
    a.current
  );
}
const _z = jt('form').withConfig({
...
function MT({
  ...
  return sn(Mz, {
    children: [
      m === 'upload'
        ? Re(_C, { children: 'Create new card' })
        : Re(_C, { children: 'Update card' }),
      sn(_z, {
        onSubmit: E(async (x) => {
      ...
      children: [
            ...
            children: [
              ...
              sn(Iz, {
                children: [
                  ...
                  Re(OC, { type: 'submit', value: 'Changed' }),
                ],
              }),
            ],
          }),
        ...
        sn(Pz, {
          children: [
            ...
            Re(zz, { onClick: k, children: '🗑 Delete Card' }),
          ],
        }),
      ],
    }),
...
function qz() {
  return sn('div', {
    children: [
      ...
      Re('p', {
        children: Re(Fi, { to: '/', children: 'Go to the home page' }),
      }),
    ],
  });
}
  ...
  return sn('div', {
    children: [
      Re('nav', {
        children: sn('ul', {
          children: [
            Re('li', { children: Re(Fi, { to: '/', children: 'Home' }) }),
            Re('li', { children: Re(Fi, { to: '/admin', children: 'Admin' }) }),
            Re('li', {
              children: Re(Fi, { to: '/orders', children: 'Orders' }),
            }),
            Re('li', {
              children: Re(Fi, { to: '/contacts', children: 'Contacts' }),
            }),
            Re('li', {
              children: Re(Fi, {
                to: '/nothing-here',
            ...
            Re(WL, {
              children: sn(Ro, {
                ...
                children: [
                  ...
                  Re(Ro, { path: 'orders', element: Re(Gz, {}) }),
                  Re(Ro, { path: 'contacts', element: Re(Wz, {}) }),
                  Re(Ro, { path: '*', element: Re(qz, {}) }),
                ],
              }),
            }),
          ],
...
FC(
  ...
  Re(ne.StrictMode, {
    children: Re(sk, {
      children: Re(Qz, { products: window.__INITIAL_PRODUCTS__ ?? [] }),
    }),
  })
);
